...
const patientSchema = z.object({
  ...
  ssn: z.string().min(14, 'SSN must be at least 14 characters').max(14, 'SSN must be 14 characters'),
  phone: z.string().optional(),
  age: z.coerce.number().min(0).optional(),
  martial_status: z.enum(['single', 'married', 'divorced', 'widowed']).optional(),
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={mutation.isPending}>
                {mutation.isPending && <span className="mr-2 h-4 w-4 animate-spin">⏳</span>}
